...
<div class="app-wrapper" id="appWrapper" style="display: <?php echo $is_logged_in ? 'flex' : 'none'; ?>;">
        ...
        <div id="page-dashboard" class="dashboard-content active">
            <div class="dashboard-header">
                ...
                <div class="user-badge" id="dashboardUser">
                    <i class="fas fa-user-circle"></i> <span id="dashboardUserName"><?php echo htmlspecialchars($user_fullname); ?></span>
                </div>
            </div>
            ...
            <div class="se-form-section">
                <form id="formPendaftaranSE">
                        ...
                        <div>
                            ...
                            <div class="se-form-group">
                                ...
                                <div class="upload-group">
                                    ...
                                    <input type="file" name="file_klasifikasi" id="se_klasifikasi_file_input" style="display: none;" accept=".pdf,.jpg,.jpeg,.png" onchange="handleFileUpload(this, 'se_klasifikasi_file', 'se_klasifikasi_info')">
                    ...
                    <div class="se-actions">
                        ...
                        <button type="submit" class="btn-se-ajukan" id="btnAjukanPengajuan" style="display: inline-block;">
                ...
                <table class="table" id="listSETable">
                    ...
                    <tbody id="listSEBody">
                        ...
                        if ($is_logged_in) {
                            ...
                            // Asumsi 'Diterima' adalah status untuk SE yang sudah terdaftar
                            $query = "SELECT * FROM layanan_se WHERE user_id = '$user_id' AND status = 'Diterima' ORDER BY tanggal_terbit DESC";
                                ...
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<td>
                                            <div style='display: flex; gap: 5px;'>
                                                <button class='icon-btn' onclick='detailSE(" . $row['id'] . ")' title='Lihat Sertifikat'>📄</button>
                                            </div>
                                          </td>";
                                    echo "<td>" . htmlspecialchars($row['instansi']) . " / " . htmlspecialchars($row['unit_kerja']) . "</td>";
                                    echo "<td>" . htmlspecialchars($row['nama_se']) . "</td>";
                                    echo "<td><span class='badge badge-green'>Terbit</span></td>";
                                    echo "<td>" . $row['tanggal_terbit'] . "</td>";
                                    echo "<td>" . $row['nomor_tanda_daftar'] . "</td>";
                                    echo "</tr>";
                                }
                            } else {
                                echo "<tr><td colspan='6'><div class='info-box'><h4>Belum Ada Data SE Terdaftar</h4><p>Anda belum memiliki SE yang terdaftar.</p></div></td></tr>";
                            }
                        }
                        ?>
                    </tbody>
                        ...
                        if ($is_logged_in) {
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if ($row['status'] == 'Diterima') $statusClass = 'badge-green';
                                    elseif ($row['status'] == 'Ditolak') $statusClass = 'badge-red';
                                    
                                    echo "<tr>";
                                    echo "<td>
                                            <div style='display: flex; gap: 5px;'>
                                                <button class='icon-btn' onclick='detailPengajuan(" . $row['id'] . ")'>📄</button>
                                                <!-- Add delete functionality later via PHP -->
                                            </div>
                                          </td>";
                                    echo "<td><span class='badge badge-blue'>Pendaftaran</span></td>";
                                ...
                                echo "<tr><td colspan='5'><div class='info-box'><i class='fas fa-history'></i><h4>Belum Ada Riwayat Pengajuan</h4><p>Anda belum melakukan pengajuan SE.</p></div></td></tr>";
                            }
                        }
                        ?>
                    </tbody>
